          ...
          child: Row(
            children: [
              Container(
                ...
                child: const Center(
                  child: Icon(Icons.local_fire_department, size: 22, color: GlutTheme.ember),
                ),
              ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        if (spot.hasWood) _Badge(l10n.amenityWood, true),
                        if (spot.hasWood) const SizedBox(width: 4),
                        if (spot.hasGrill) _Badge(l10n.amenityGrill, true),
                        if (spot.hasGrill) const SizedBox(width: 4),
                        if (spot.hasFireplace) _Badge(l10n.amenityFireplace, true),
                        if (!spot.hasWood && !spot.hasGrill && !spot.hasFireplace)
                          _Badge(l10n.amenityNoInfo, false),
                      ],
                    ),
                  ],
                ),
